      ...
      <div className="flex flex-col gap-6 w-full max-w-42rem">
        ...
        <div className="flex flex-wrap gap-3">
          {skills.map((skill) => (
            <div
              key={skill.label}
              className="flex items-center gap-2 px-3 py-2 rounded-md border border-zinc-300 dark:border-zinc-700 bg-white/50 dark:bg-zinc-800/50 hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors shadow-sm"
            >
              <img
